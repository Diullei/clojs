...
var compile_$_script = function (file) {
    closerAssertions.arity(1, arguments.length);
    return function () {
        ...
        return fs['writeFile'](core.apply.call(this, core.str, path['dirname'](file), '/', path['basename'](file, '.cljs'), '.js'), compiled, function (err) {
            closerAssertions.arity(1, arguments.length);
...
if (core._$EQ_.call(this, core.count.call(this, proc), 2))
    ...
    try {
        (function () {
            ...
            return (typeof command_$_options['compile'] === 'function' && command_$_options['compile'].length === 0 ? command_$_options['compile']() : command_$_options['compile']) ? compile_$_script.call(this, core.first.call(this, typeof command_$_options['_'] === 'function' && command_$_options['_'].length === 0 ? command_$_options['_']() : command_$_options['_'])) : (typeof command_$_options['help'] === 'function' && command_$_options['help'].length === 0 ? command_$_options['help']() : command_$_options['help']) ? core.println.call(this, (typeof opt['generateHelp'] === 'function' && opt['generateHelp'].length === 0 ? opt['generateHelp']() : opt['generateHelp']).call(this, core.clj_$__$GT_js.call(this, core.hash_$_map(core.keyword('interpolate'), core.hash_$_map(core.keyword('version'), '0.0.0'))))) : (typeof command_$_options['version'] === 'function' && command_$_options['version'].length === 0 ? command_$_options['version']() : command_$_options['version']) ? core.println.call(this, 'version 0.0.0') : (typeof command_$_options['eval'] === 'function' && command_$_options['eval'].length === 0 ? command_$_options['eval']() : command_$_options['eval']) ? compile_$_script_$_from_$_str.call(this, typeof command_$_options['_'] === 'function' && command_$_options['_'].length === 0 ? command_$_options['_']() : command_$_options['_']) : null;
        }.call(this));
    } catch (e) {
