...
opt = optionator.call(this, core.clj_$__$GT_js.call(this, core.hash_$_map(core.keyword('prepend'), 'Usage: cljsc [option]... [file]...\n\nUse \'cljsc\' with no options to start REPL.', core.keyword('append'), 'Version {{version}}\n<http://clojs.org/>', core.keyword('helpStyle'), core.hash_$_map(core.keyword('maxPadFactor'), 1.9), core.keyword('positionalAnywhere'), false, core.keyword('options'), core.vector(core.hash_$_map(core.keyword('option'), 'version', core.keyword('alias'), 'v', core.keyword('type'), 'Boolean', core.keyword('description'), 'display version'), core.hash_$_map(core.keyword('option'), 'help', core.keyword('alias'), 'h', core.keyword('type'), 'Boolean', core.keyword('description'), 'display this help message'), core.hash_$_map(core.keyword('option'), 'compile', core.keyword('alias'), 'c', core.keyword('type'), 'Boolean', core.keyword('description'), 'compile to JavaScript and save as .js files'), core.hash_$_map(core.keyword('option'), 'output', core.keyword('alias'), 'o', core.keyword('type'), 'path::String', core.keyword('description'), 'compile into the specified directory'), core.hash_$_map(core.keyword('option'), 'ast', core.keyword('alias'), 'a', core.keyword('type'), 'Boolean', core.keyword('description'), 'Sow AST'), core.hash_$_map(core.keyword('option'), 'eval', core.keyword('alias'), 'e', core.keyword('type'), 'code::String', core.keyword('description'), 'pass as string from the command line as input')))));
