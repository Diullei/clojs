fs = require.call(this, 'fs');
path = require.call(this, 'path');
util = require.call(this, 'util');
escodegen = require.call(this, 'escodegen');
optionator = require.call(this, 'optionator');
closer = require.call(this, './index');
pkg = require.call(this, '../../package.json');
core = typeof closer['core'] === 'function' && closer['core'].length === 0 ? closer['core']() : closer['core'];
closerAssertions = typeof closer['assertions'] === 'function' && closer['assertions'].length === 0 ? closer['assertions']() : closer['assertions'];
opt = optionator.call(this, core.clj_$__$GT_js.call(this, core.hash_$_map(core.keyword('prepend'), 'Usage: cljsc [option]... [file]...\n\nUse \'cljsc\' with no options to start REPL.', core.keyword('append'), 'Version {{version}}\n<http://clojs.org/>', core.keyword('helpStyle'), core.hash_$_map(core.keyword('maxPadFactor'), 1.9), core.keyword('positionalAnywhere'), false, core.keyword('options'), core.vector(core.hash_$_map(core.keyword('option'), 'version', core.keyword('alias'), 'v', core.keyword('type'), 'Boolean', core.keyword('description'), 'display version'), core.hash_$_map(core.keyword('option'), 'help', core.keyword('alias'), 'h', core.keyword('type'), 'Boolean', core.keyword('description'), 'display this help message'), core.hash_$_map(core.keyword('option'), 'compile', core.keyword('alias'), 'c', core.keyword('type'), 'Boolean', core.keyword('description'), 'compile to JavaScript and save as .js files'), core.hash_$_map(core.keyword('option'), 'output', core.keyword('alias'), 'o', core.keyword('type'), 'path::String', core.keyword('description'), 'compile into the specified directory'), core.hash_$_map(core.keyword('option'), 'ast', core.keyword('alias'), 'a', core.keyword('type'), 'code::String', core.keyword('description'), 'Sow AST'), core.hash_$_map(core.keyword('option'), 'eval', core.keyword('alias'), 'e', core.keyword('type'), 'code::String', core.keyword('description'), 'pass as string from the command line as input')))));
...
var parse = function (code) {
    closerAssertions.arity(1, arguments.length);
    return closer['parse'](code, core.clj_$__$GT_js.call(this, core.hash_$_map(core.keyword('coreIdentifier'), 'core')));
};
var compile_$_script_$_from_$_str = function (code) {
    closerAssertions.arity(1, arguments.length);
    return function () {
        var ast = parse.call(this, code);
...
proc = core.js_$__$GT_clj.call(this, typeof process['argv'] === 'function' && process['argv'].length === 0 ? process['argv']() : process['argv']);
if (core._$EQ_.call(this, core.count.call(this, proc), 2))
    require.call(this, './start-repl');
else
    try {
        (function () {
